...
# Use C5_log instead of C5 for training and evaluation
train_y = torch.tensor(train_papers_filtered['C5_log'].values, dtype=torch.float)
val_y = torch.tensor(val_papers_filtered['C5_log'].values, dtype=torch.float)
