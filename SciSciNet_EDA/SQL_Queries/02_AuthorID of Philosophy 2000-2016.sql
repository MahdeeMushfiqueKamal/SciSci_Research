...
CREATE OR REPLACE TABLE `sciscinet-mahdee.SciSciNet.PhilosophyAuthors_2000_16` AS
...
FROM (
    ...
    INNER JOIN `sciscinet-mahdee.SciSciNet.PhilosophyPapers_2000_15` p  
    ...
    INNER JOIN `sciscinet-mahdee.SciSciNet.SciSciNet_PaperAuthorAffiliations` ap
        ON a.AuthorID = ap.AuthorID
    INNER JOIN `sciscinet-mahdee.SciSciNet.PhilosophyPapers_2016` p  
        ON ap.PaperID = p.PaperID
) combined_authors