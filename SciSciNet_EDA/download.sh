...
# Check if the file SciSciNet_Papers.tsv (16 GB) exists in the current directory
...
# Check if the file SciSciNet_Fields.tsv (9.3 KB) exists in the current directory
...
# Check if the file SciSciNet_PaperFields.tsv (11.62 GB) exists in the current directory
